...
> Thanks to the [document](https://raw.githubusercontent.com/HackerNews/API/master/README.md) 🙏！
...
For versioning purposes, only removal of a non-optional field or alteration of an existing field will be considered incompatible changes. \_Clients should gracefully handle additional fields they don't expect, and simply ignore them.
